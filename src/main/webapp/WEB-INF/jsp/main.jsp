        ...
        <%--<section class="col-lg-7 connectedSortable">--%>
          ...
          <%--<div class="box box-success">--%>
            ...
            <%--<div class="box-body chat" id="chat-box">--%>
              <%--<!-- chat item -->--%>
              <%--<div class="item">--%>
                <%--<img src="<%=path%>/static/AdminLTE-2.4.2/dist/img/user4-128x128.jpg" alt="user image" class="online">--%>
              ...
              <%--<!-- chat item -->--%>
              <%--<div class="item">--%>
                <%--<img src="<%=path%>/static/AdminLTE-2.4.2/dist/img/user3-128x128.jpg" alt="user image" class="offline">--%>
              ...
              <%--<!-- chat item -->--%>
              <%--<div class="item">--%>
                <%--<img src="<%=path%>/static/AdminLTE-2.4.2/dist/img/user2-160x160.jpg" alt="user image" class="offline">--%>
          ...
          <%--<div class="box box-primary">--%>
            ...
            <%--<!-- /.box-header -->--%>
            <%--<div class="box-body">--%>
              <%--<!-- See <%=path%>/static/AdminLTE-2.4.2/dist/js/<%=path%>/static/AdminLTE-2.4.2/pages/dashboard.js to activate the todoList plugin -->--%>
              <%--<ul class="todo-list">--%>
                <%--<li>--%>
                  <%--<!-- drag handle -->--%>
                  <%--<span class="handle">--%>
