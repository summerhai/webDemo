...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="static/AdminLTE-2.4.2/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="static/AdminLTE-2.4.2/index2.html"><b>安全环境监测SEMS®</b>一体化平台</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg"></p>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" id="loginButton">登录</button>
        </div>
        <!-- /.col -->
      </div>
    ...
    <%--<div class="social-auth-links text-center">--%>
      <%--<p>- OR -</p>--%>
      <%--<a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> 微信登录--%>
        <%--</a>--%>
      <%--<a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> QQ登录--%>
        <%--</a>--%>
    <%--</div>--%>
    <!-- /.social-auth-links -->
...
<!-- iCheck -->
<script src="static/AdminLTE-2.4.2/plugins/iCheck/icheck.min.js"></script>
