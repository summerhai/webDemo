...
public class DataTablePageUtil<T> {
    ...
    public DataTablePageUtil(HttpServletRequest request) {
        ...
        System.out.println("本次分页的length="+length);
        //DT传递的draw:
        ...
        this.setOrder(num);
        String orderWay = request.getParameter("order[0][dir]");
        System.out.println("way="+orderWay);
        this.order_dir = orderWay;
        ...
        this.setPage_size(Integer.valueOf(length));
    }
